...
|---|---|---|---|---|---|
| PAIR-001 | 4. initialize | `protocol/src/core/UniswapV2Pair.sol` | `test_initialize_nonFactory_revert,test_initialize_reentryBlocked,test_initialize_invalidQuote,test_initialize_taxTooHigh_revert` | `FOUNDRY_OFFLINE=true forge test --match-contract FactoryAdminExtTest` | Implemented |
| PAIR-002 | 9. setTaxConfig | `protocol/src/core/UniswapV2Pair.sol` | `test_setTaxConfig_maxTax_revert,test_setTaxConfig_zeroCollector,test_setTaxConfig_nonFactory_revert` | `FOUNDRY_OFFLINE=true forge test --match-contract FactoryAdminExtTest` | Implemented |
| PAIR-003 | 6. swap single-side | `protocol/src/core/UniswapV2Pair.sol` | `test_singleSideOnly_revert` | `FOUNDRY_OFFLINE=true forge test --match-test test_singleSideOnly_revert` | Implemented |
| PAIR-004 | 6. swap invalid to | `protocol/src/core/UniswapV2Pair.sol` | `test_swap_invalidTo_revert` | `FOUNDRY_OFFLINE=true forge test --match-test test_swap_invalidTo_revert` | Implemented |
| PAIR-005 | 6. sell reverse ceil | `protocol/src/core/UniswapV2Pair.sol` | `test_sell_reverseMath_ceilGross` | `FOUNDRY_OFFLINE=true forge test --match-test test_sell_reverseMath_ceilGross` | Implemented |
| PAIR-006 | 6. buy pre-deduction | `protocol/src/core/UniswapV2Pair.sol` | `test_buy_preDeduction_taxIn` | `FOUNDRY_OFFLINE=true forge test --match-test test_buy_preDeduction_taxIn` | Implemented |
| PAIR-007 | 6. non-zero input | `protocol/src/core/UniswapV2Pair.sol` | `test_swap_zeroInput_revert` | `FOUNDRY_OFFLINE=true forge test --match-test test_swap_zeroInput_revert` | Implemented |
...
| FACT-004 | 10. base allowlist removed | `protocol/src/core/UniswapV2Factory.sol` | `test_createPair_unlistedBase_success` | `FOUNDRY_OFFLINE=true forge test --match-test test_createPair_unlistedBase_success` | Implemented |
...
| FACT-008 | 10. base allowlist API removed | `protocol/src/core/UniswapV2Factory.sol` | `test_baseAllowlistApi_setter_removed,test_baseAllowlistApi_getter_removed` | `FOUNDRY_OFFLINE=true forge test --match-contract FactoryAdminExtTest` | Implemented |
...
| ROUT-001 | 10. remove auto pair creation | `protocol/src/periphery/UniswapV2Router02.sol` | `test_router_noPairRevert` | `FOUNDRY_OFFLINE=true forge test --match-test test_router_noPairRevert` | Implemented |
| ROUT-002 | 10. FOT hard revert | `protocol/src/periphery/UniswapV2Router02.sol` | `test_router_supportingFOT_notSupported,test_router_supportingFOT_notSupported_exactETHForTokens,test_router_supportingFOT_notSupported_exactTokensForETH,test_router_supportingFOT_notSupported_removeLiquidityETH,test_router_supportingFOT_notSupported_removeLiquidityETHWithPermit` | `FOUNDRY_OFFLINE=true forge test --match-contract RouterLibraryTest` | Implemented |
