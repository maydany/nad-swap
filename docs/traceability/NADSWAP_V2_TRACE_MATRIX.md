...
| `test_createPair_baseUnsupported_revert` | `protocol/test/core/Factory.t.sol` | `FOUNDRY_OFFLINE=true forge test --match-test test_createPair_baseUnsupported_revert` | Implemented |
...
| `test_baseToken_fot_unsupported` | `protocol/test/periphery/PolicyEnforcement.t.sol` | `FOUNDRY_OFFLINE=true forge test --match-test test_baseToken_fot_unsupported` | Implemented |
