...
| LIB-003 | 11. sell exact-in direct floor post-deduction | `protocol/src/periphery/libraries/NadSwapV2Library.sol` | `test_sellExactIn_safeMargin_avoidsLiquidityEdge` | `FOUNDRY_OFFLINE=true forge test --match-test test_sellExactIn_safeMargin_avoidsLiquidityEdge` | Implemented |
